...
class Google_Service_PlusDomains_Activities_Resource extends Google_Service_Resource {
	 ...
	 *
	 * @param string $userId
	 *        	The ID of the user to get activities for. The special
...
class Google_Service_PlusDomains_Audiences_Resource extends Google_Service_Resource {
	 ...
	 *
	 * @param string $userId
	 *        	The ID of the user to get audiences for. The special
	 *        	value "me" can be used to indicate the authenticated user.
	 * @param array $optParams
	 *        	Optional parameters.
	 *        	
...
class Google_Service_PlusDomains_Circles_Resource extends Google_Service_Resource {
	 ...
	 *
	 * @param string $userId
	 *        	The ID of the user to create the circle on behalf of.
	 ...
	 *
	 * @param string $userId
	 *        	The ID of the user to get circles for. The special
	 *        	value "me" can be used to indicate the authenticated user.
	 * @param array $optParams
	 *        	Optional parameters.
	 *        	
...
class Google_Service_PlusDomains_People_Resource extends Google_Service_Resource {
	 ...
	 *
	 * @param string $userId
	 *        	The ID of the person to get the profile for. The
	 ...
	 *
	 * @param string $activityId
	 *        	The ID of the activity to get the list of people
	 *        	for.
	 * @param string $collection
	 *        	The collection of people to list.
	 * @param array $optParams
