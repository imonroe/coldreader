...
class Google_Service_AdExchangeBuyer extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->budget = new Google_Service_AdExchangeBuyer_Budget_Resource ( $this, $this->serviceName, 'budget', array (
				'methods' => array (
						'get' => array (
...
class Google_Service_AdExchangeBuyer_Budget_Resource extends Google_Service_Resource {
	 ...
	 *
	 * @param string $accountId
	 *        	The account id associated with the budget being
	 *        	updated.
	 * @param string $billingId
	 *        	The billing id associated with the budget being
	 *        	updated.
...
class Google_Service_AdExchangeBuyer_PerformanceReport_Resource extends Google_Service_Resource {
	 ...
	 *        	The end time of the report in ISO 8601 timestamp
	 *        	format using UTC.
	 * @param string $startDateTime
	 *        	The start time of the report in ISO 8601
...
class Google_Service_AdExchangeBuyer_PretargetingConfig_Resource extends Google_Service_Resource {
	 ...
	 *
	 * @param string $accountId
	 *        	The account id to delete the pretargeting config
	 *        	for.
	 ...
	 *
	 * @param string $accountId
	 *        	The account id to insert the pretargeting config
	 *        	for.
	 ...
	 *
	 * @param string $accountId
	 *        	The account id to update the pretargeting config
	 *        	for.
	 * @param string $configId
