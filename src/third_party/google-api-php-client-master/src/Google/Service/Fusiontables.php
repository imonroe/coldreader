...
class Google_Service_Fusiontables_Column_Resource extends Google_Service_Resource {
	 ...
	 * @param string $columnId
	 *        	Name or identifier for the column that is being
	 *        	requested.
	 * @param array $optParams
	 *        	Optional parameters.
...
class Google_Service_Fusiontables_Query_Resource extends Google_Service_Resource {
	 ...
	 * - UPDATE - DELETE - SHOW - DESCRIBE - CREATE statement.
	 * (query.sql)
	 *
	 * @param string $sql
	 ...
	 *
	 * @param string $sql
	 *        	A SQL statement which can be any of - SELECT - SHOW -
	 *        	DESCRIBE
	 * @param array $optParams
	 *        	Optional parameters.
	 *        	
...
class Google_Service_Fusiontables_Table_Resource extends Google_Service_Resource {
	 ...
	 * Current rows remain visible until all
	...
	public function replaceRows($tableId, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'replaceRows', array (
				$params 
...
class Google_Service_Fusiontables_Template_Resource extends Google_Service_Resource {
	 ...
	 *
	 * @param string $tableId
	 *        	Identifier for the table whose templates are being
	 *        	requested
	 * @param array $optParams
	 *        	Optional parameters.
	 *        	
