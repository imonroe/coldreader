...
class Google_Service_YouTubeAnalytics extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->groupItems = new Google_Service_YouTubeAnalytics_GroupItems_Resource ( $this, $this->serviceName, 'groupItems', array (
				'methods' => array (
						'delete' => array (
								'path' => 'groupItems',
								'httpMethod' => 'DELETE',
		...
		$this->groups = new Google_Service_YouTubeAnalytics_Groups_Resource ( $this, $this->serviceName, 'groups', array (
				'methods' => array (
						'delete' => array (
								'path' => 'groups',
								'httpMethod' => 'DELETE',
...
class Google_Service_YouTubeAnalytics_BatchReports_Resource extends Google_Service_Resource {
	 ...
	 *        	The batchReportDefinitionId parameter
...
class Google_Service_YouTubeAnalytics_GroupItems_Resource extends Google_Service_Resource {
	 ...
	 *
	 * @param string $id
	 *        	The id parameter specifies the YouTube group item ID for
	 ...
	 *        	The id parameter specifies the unique ID of the group
...
class Google_Service_YouTubeAnalytics_Groups_Resource extends Google_Service_Resource {
	 ...
	 *
	 * @param string $id
	 *        	The id parameter specifies the YouTube group ID for the
...
class Google_Service_YouTubeAnalytics_Reports_Resource extends Google_Service_Resource {
	 ...
	 *
	 * @param string $ids
	 *        	Identifies the YouTube channel or content owner for which
	 ...
	 *        	The end date for fetching YouTube Analytics data. The
	 *        	value should be in YYYY-MM-DD format.
	 * @param string $metrics
	 *        	A comma-separated list of YouTube Analytics metrics,
