...
class Google_Service_ShoppingContent extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->accountshipping = new Google_Service_ShoppingContent_Accountshipping_Resource ( $this, $this->serviceName, 'accountshipping', array (
				'methods' => array (
						'custombatch' => array (
		...
		$this->accounttax = new Google_Service_ShoppingContent_Accounttax_Resource ( $this, $this->serviceName, 'accounttax', array (
				'methods' => array (
						'custombatch' => array (
...
class Google_Service_ShoppingContent_Accounts_Resource extends Google_Service_Resource {
	...
	public function authinfo($optParams = array()) {
		...
		return $this->call ( 'authinfo', array (
				$params 
...
class Google_Service_ShoppingContent_Accountshipping_Resource extends Google_Service_Resource {
	 ...
	 *        	The ID of the managing account.
	 * @param string $accountId
	 *        	The ID of the account for which to get/update
...
class Google_Service_ShoppingContent_Inventory_Resource extends Google_Service_Resource {
	 ...
	 *        	The code of the store for which to update price and
	 *        	availability. Use online to update price and availability of an online
	 *        	product.
	 * @param string $productId
	 *        	The ID of the product for which to update price and
	 *        	availability.
