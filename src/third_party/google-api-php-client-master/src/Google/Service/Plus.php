...
class Google_Service_Plus_Moments_Resource extends Google_Service_Resource {
	 ...
	 *
	 * @param string $userId
	 *        	The ID of the user to record actions for. The only
	 ...
	 *
	 * @param string $userId
	 *        	The ID of the user to get moments for. The special
	 *        	value "me" can be used to indicate the authenticated user.
	 * @param string $collection
...
class Google_Service_Plus_People_Resource extends Google_Service_Resource {
	 ...
	 *
	 * @param string $query
	 *        	Specify a query string for full text search of public
