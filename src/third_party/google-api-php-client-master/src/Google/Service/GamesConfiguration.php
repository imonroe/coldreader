...
class Google_Service_GamesConfiguration extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->achievementConfigurations = new Google_Service_GamesConfiguration_AchievementConfigurations_Resource ( $this, $this->serviceName, 'achievementConfigurations', array (
				'methods' => array (
						'delete' => array (
		...
		$this->imageConfigurations = new Google_Service_GamesConfiguration_ImageConfigurations_Resource ( $this, $this->serviceName, 'imageConfigurations', array (
				'methods' => array (
						'upload' => array (
		...
		$this->leaderboardConfigurations = new Google_Service_GamesConfiguration_LeaderboardConfigurations_Resource ( $this, $this->serviceName, 'leaderboardConfigurations', array (
				'methods' => array (
						'delete' => array (
