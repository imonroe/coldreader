...
class Google_Service_Computeaccounts extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->globalAccountsOperations = new Google_Service_Computeaccounts_GlobalAccountsOperations_Resource ( $this, $this->serviceName, 'globalAccountsOperations', array (
				'methods' => array (
						'delete' => array (
		...
		$this->groups = new Google_Service_Computeaccounts_Groups_Resource ( $this, $this->serviceName, 'groups', array (
				'methods' => array (
						'addMember' => array (
		...
		$this->linux = new Google_Service_Computeaccounts_Linux_Resource ( $this, $this->serviceName, 'linux', array (
				'methods' => array (
		...
		$this->users = new Google_Service_Computeaccounts_Users_Resource ( $this, $this->serviceName, 'users', array (
				'methods' => array (
						'addPublicKey' => array (
...
class Google_Service_Computeaccounts_Groups_Resource extends Google_Service_Resource {
	...
	public function addMember($project, $groupName, Google_Service_Computeaccounts_GroupsAddMemberRequest $postBody, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'addMember', array (
				$params 
		), "Google_Service_Computeaccounts_Operation" );
	}
	...
	public function removeMember($project, $groupName, Google_Service_Computeaccounts_GroupsRemoveMemberRequest $postBody, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'removeMember', array (
				$params 
		), "Google_Service_Computeaccounts_Operation" );
	}
}
...
class Google_Service_Computeaccounts_Linux_Resource extends Google_Service_Resource {
	 ...
	 *        	The fully-qualified URL of the instance requesting
	 *        	the view.
	 * @param array $optParams
	 *        	Optional parameters.
	...
	public function getAuthorizedKeysView($project, $zone, $user, $instance, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'getAuthorizedKeysView', array (
				$params 
	...
	public function getLinuxAccountViews($project, $zone, $instance, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'getLinuxAccountViews', array (
				$params 
...
class Google_Service_Computeaccounts_Users_Resource extends Google_Service_Resource {
	...
	public function addPublicKey($project, $user, Google_Service_Computeaccounts_PublicKey $postBody, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'addPublicKey', array (
				$params 
		), "Google_Service_Computeaccounts_Operation" );
	}
	...
	public function removePublicKey($project, $user, $fingerprint, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'removePublicKey', array (
				$params 
		), "Google_Service_Computeaccounts_Operation" );
	}
}
