...
class Google_Service_SQLAdmin extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->databases = new Google_Service_SQLAdmin_Databases_Resource ( $this, $this->serviceName, 'databases', array (
				'methods' => array (
						'delete' => array (
		...
		$this->users = new Google_Service_SQLAdmin_Users_Resource ( $this, $this->serviceName, 'users', array (
				'methods' => array (
						'delete' => array (
...
class Google_Service_SQLAdmin_Instances_Resource extends Google_Service_Resource {
	 ...
	 *
	 * @param string $project
	 *        	Project ID of the source as well as the clone Cloud
	 *        	SQL instance.
	 * @param string $instance
	 ...
	 *
	 * @param string $project
	 *        	Project ID of the project to which the newly created
	...
	public function startReplica($project, $instance, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'startReplica', array (
				$params 
		), "Google_Service_SQLAdmin_Operation" );
	}
	...
	public function stopReplica($project, $instance, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'stopReplica', array (
				$params 
		), "Google_Service_SQLAdmin_Operation" );
	}
