...
class Google_Service_Gmail extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->users = new Google_Service_Gmail_Users_Resource ( $this, $this->serviceName, 'users', array (
				'methods' => array (
						'getProfile' => array (
								'path' => '{userId}/profile',
								'httpMethod' => 'GET',
...
class Google_Service_Gmail_Users_Resource extends Google_Service_Resource {
	...
	public function getProfile($userId, $optParams = array()) {
		...
		return $this->call ( 'getProfile', array (
				$params 
...
class Google_Service_Gmail_UsersMessages_Resource extends Google_Service_Resource {
	 ...
	 * scanning and classification similar to receiving via SMTP.
	 * Does not send a
