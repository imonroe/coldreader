...
class Google_Service_Reseller_Subscriptions_Resource extends Google_Service_Resource {
	 ...
	 *        	Id of the subscription, which is unique for a
	 *        	customer
	 * @param array $optParams
	 *        	Optional parameters.
	...
	public function activate($customerId, $subscriptionId, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'activate', array (
				$params 
	 ...
	 *        	Whether the subscription is to be fully cancelled
	 *        	or downgraded
	 * @param array $optParams
	 *        	Optional parameters.
	 */
	...
	public function suspend($customerId, $subscriptionId, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'suspend', array (
				$params 
		), "Google_Service_Reseller_Subscription" );
	}
}
