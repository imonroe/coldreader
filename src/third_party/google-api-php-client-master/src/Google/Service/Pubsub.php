...
class Google_Service_Pubsub extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->projects_subscriptions = new Google_Service_Pubsub_ProjectsSubscriptions_Resource ( $this, $this->serviceName, 'subscriptions', array (
				'methods' => array (
						'acknowledge' => array (
		...
		$this->projects_topics = new Google_Service_Pubsub_ProjectsTopics_Resource ( $this, $this->serviceName, 'topics', array (
				'methods' => array (
						'create' => array (
								'path' => '{+name}',
								'httpMethod' => 'PUT',
		...
		$this->projects_topics_subscriptions = new Google_Service_Pubsub_ProjectsTopicsSubscriptions_Resource ( $this, $this->serviceName, 'subscriptions', array (
				'methods' => array (
						'list' => array (
...
class Google_Service_Pubsub_ProjectsSubscriptions_Resource extends Google_Service_Resource {
	 ...
	 * Returns an empty list if there are no
...
class Google_Service_Pubsub_ProjectsTopics_Resource extends Google_Service_Resource {
	 ...
	 * Returns NOT_FOUND if the topic does
