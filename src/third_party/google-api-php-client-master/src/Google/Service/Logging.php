...
class Google_Service_Logging extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->projects_logServices = new Google_Service_Logging_ProjectsLogServices_Resource ( $this, $this->serviceName, 'logServices', array (
				'methods' => array (
						'list' => array (
		...
		$this->projects_logServices_indexes = new Google_Service_Logging_ProjectsLogServicesIndexes_Resource ( $this, $this->serviceName, 'indexes', array (
				'methods' => array (
						'list' => array (
		...
		$this->projects_logServices_sinks = new Google_Service_Logging_ProjectsLogServicesSinks_Resource ( $this, $this->serviceName, 'sinks', array (
				'methods' => array (
						'create' => array (
		...
		$this->projects_logs = new Google_Service_Logging_ProjectsLogs_Resource ( $this, $this->serviceName, 'logs', array (
				'methods' => array (
						'delete' => array (
		...
		$this->projects_logs_entries = new Google_Service_Logging_ProjectsLogsEntries_Resource ( $this, $this->serviceName, 'entries', array (
				'methods' => array (
						'write' => array (
		...
		$this->projects_logs_sinks = new Google_Service_Logging_ProjectsLogsSinks_Resource ( $this, $this->serviceName, 'sinks', array (
				'methods' => array (
						'create' => array (
...
class Google_Service_Logging_ProjectsLogServices_Resource extends Google_Service_Resource {
	 ...
	 *        	Part of `projectName`. The project resource whose
...
class Google_Service_Logging_ProjectsLogServicesIndexes_Resource extends Google_Service_Resource {
	 ...
	 *
	 * @param string $projectsId
	 *        	Part of `serviceName`. A log service resource of
	 ...
	 * @param string $logServicesId
	 *        	Part of `serviceName`. See documentation of
	 *        	`projectsId`.
	 * @param array $optParams
	 *        	Optional parameters.
	 *        	
...
class Google_Service_Logging_ProjectsLogServicesSinks_Resource extends Google_Service_Resource {
	 ...
	 *
	 * @param string $projectsId
	 *        	Part of `serviceName`. The name of the service in
	 ...
	 * @param string $logServicesId
	 *        	Part of `sinkName`. See documentation of
	 *        	`projectsId`.
	 * @param string $sinksId
	 ...
	 *
	 * @param string $projectsId
	 *        	Part of `serviceName`. The name of the service for
	 *        	which to list sinks.
	 * @param string $logServicesId
	 *        	Part of `serviceName`. See documentation of
	 *        	`projectsId`.
...
class Google_Service_Logging_ProjectsLogs_Resource extends Google_Service_Resource {
	 ...
	 *
	 * @param string $projectsId
	 *        	Part of `projectName`. The project name for which
...
class Google_Service_Logging_ProjectsLogsEntries_Resource extends Google_Service_Resource {
	...
	/**
	 * Creates one or more log entries in a log.
	 * You must supply a list of
...
class Google_Service_Logging_ProjectsLogsSinks_Resource extends Google_Service_Resource {
	 ...
	 *
	 * @param string $projectsId
	 *        	Part of `logName`. The log in which to create a
	 *        	sink resource.
	 * @param string $logsId
	 *        	Part of `logName`. See documentation of `projectsId`.
	 * @param Google_LogSink $postBody        	
	 ...
	 *
	 * @param string $projectsId
	 *        	Part of `sinkName`. The name of the sink resource
	 *        	to return.
	 * @param string $logsId
	 *        	Part of `sinkName`. See documentation of `projectsId`.
	 * @param string $sinksId
