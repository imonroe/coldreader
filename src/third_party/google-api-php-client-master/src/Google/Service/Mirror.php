...
class Google_Service_Mirror_Accounts_Resource extends Google_Service_Resource {
	 ...
	 *        	Account type to be passed to Android Account
	 *        	Manager.
	 * @param string $accountName
	 *        	The name of the account to be passed to the
...
class Google_Service_Mirror_Locations_Resource extends Google_Service_Resource {
	 ...
	 *
	 * @param string $id
	 *        	The ID of the location or latest for the last known
	 *        	location.
	 * @param array $optParams
	 *        	Optional parameters.
...
class Google_Service_Mirror_TimelineAttachments_Resource extends Google_Service_Resource {
	 ...
	 *
	 * @param string $itemId
	 *        	The ID of the timeline item whose attachments should be
	 *        	listed.
	 * @param array $optParams
	 *        	Optional parameters.
