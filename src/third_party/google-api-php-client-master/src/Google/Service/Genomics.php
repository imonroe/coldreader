...
class Google_Service_Genomics extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->annotationSets = new Google_Service_Genomics_AnnotationSets_Resource ( $this, $this->serviceName, 'annotationSets', array (
				'methods' => array (
						'create' => array (
								'path' => 'annotationSets',
								'httpMethod' => 'POST',
		...
		$this->annotations = new Google_Service_Genomics_Annotations_Resource ( $this, $this->serviceName, 'annotations', array (
				'methods' => array (
						'batchCreate' => array (
		...
		$this->readgroupsets_coveragebuckets = new Google_Service_Genomics_ReadgroupsetsCoveragebuckets_Resource ( $this, $this->serviceName, 'coveragebuckets', array (
				'methods' => array (
						'list' => array (
		...
		$this->references = new Google_Service_Genomics_References_Resource ( $this, $this->serviceName, 'references', array (
				'methods' => array (
						'get' => array (
		...
		$this->references_bases = new Google_Service_Genomics_ReferencesBases_Resource ( $this, $this->serviceName, 'bases', array (
				'methods' => array (
						'list' => array (
		...
		$this->referencesets = new Google_Service_Genomics_Referencesets_Resource ( $this, $this->serviceName, 'referencesets', array (
				'methods' => array (
						'get' => array (
		...
		$this->streamingReadstore = new Google_Service_Genomics_StreamingReadstore_Resource ( $this, $this->serviceName, 'streamingReadstore', array (
				'methods' => array (
						'streamreads' => array (
		...
		$this->variantsets = new Google_Service_Genomics_Variantsets_Resource ( $this, $this->serviceName, 'variantsets', array (
				'methods' => array (
						'delete' => array (
...
class Google_Service_Genomics_AnnotationSets_Resource extends Google_Service_Resource {
	 ...
	 * Caller must have WRITE permission for the
	 ...
	 * Caller must have READ permission for the associated
	 ...
	 * The update must respect all mutability
...
class Google_Service_Genomics_Annotations_Resource extends Google_Service_Resource {
	...
	public function batchCreate(Google_Service_Genomics_BatchCreateAnnotationsRequest $postBody, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'batchCreate', array (
				$params 
	 ...
	 * Caller must have WRITE permission for the associated
	 ...
	 * The update must respect all mutability restrictions
...
class Google_Service_Genomics_Readgroupsets_Resource extends Google_Service_Resource {
	 ...
	 * Storage.
	 * See the alignment and variant calling documentation for more
	 ...
	 * See the alignment and variant calling documentation
	 ...
	 *        	The ID of the read group set to be deleted. The
	 ...
	 *
	 * @param string $readGroupSetId
	 *        	The ID of the read group set to be updated. The
	 *        	caller must have WRITE permissions to the dataset associated with this read
	 *        	group set.
...
class Google_Service_Genomics_ReadgroupsetsCoveragebuckets_Resource extends Google_Service_Resource {
	 ...
	 *
	 * @param string $readGroupSetId
	 *        	Required. The ID of the read group set over
...
class Google_Service_Genomics_StreamingReadstore_Resource extends Google_Service_Resource {
	...
	/**
	 * Gets a stream of reads for one or more read group sets.
	 * Reads search operates
	 * over a genomic coordinate space of reference sequence & position defined over
	 * the reference sequences to which the requested read group sets are aligned.
	 *
	...
	public function streamreads(Google_Service_Genomics_StreamReadsRequest $postBody, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'streamreads', array (
				$params 
...
class Google_Service_Genomics_Variantsets_Resource extends Google_Service_Resource {
	 ...
	 *
	 * @param string $variantSetId
	 *        	Required. The ID of the variant set that contains
	 ...
	 *
	 * @param string $variantSetId
	 *        	Required. The variant set to which variant data
	 *        	should be imported.
	...
	public function importVariants($variantSetId, Google_Service_Genomics_ImportVariantsRequest $postBody, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'importVariants', array (
				$params 
	...
	public function mergeVariants($variantSetId, Google_Service_Genomics_MergeVariantsRequest $postBody, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'mergeVariants', array (
				$params 
		) );
	}
	 ...
	 * All other modifications are silently
