...
class Google_Service_Books extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->dictionary = new Google_Service_Books_Dictionary_Resource ( $this, $this->serviceName, 'dictionary', array (
				'methods' => array (
		...
		$this->onboarding = new Google_Service_Books_Onboarding_Resource ( $this, $this->serviceName, 'onboarding', array (
				'methods' => array (
...
class Google_Service_Books_Dictionary_Resource extends Google_Service_Resource {
	...
	public function listOfflineMetadata($cpksver, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'listOfflineMetadata', array (
				$params 
...
class Google_Service_Books_LayersAnnotationData_Resource extends Google_Service_Resource {
	 ...
	 *        	The content version for the volume you are
	 *        	trying to retrieve.
	 * @param array $optParams
	 *        	Optional parameters.
	 *        	
...
class Google_Service_Books_Myconfig_Resource extends Google_Service_Resource {
	...
	public function getUserSettings($optParams = array()) {
		$params = array ();
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'getUserSettings', array (
				$params 
	 ...
	 * @param string $cpksver
	 *        	The device/version ID from which to release the
	 *        	restriction.
	 * @param array $optParams
	 *        	Optional parameters.
	 *        	
	 ...
	 * @param string $volumeId
	 *        	The volume to request concurrent/download
	 *        	restrictions for.
	 * @param string $nonce
	 *        	The client nonce value.
	 * @param string $cpksver
	 *        	The device/version ID from which to request the
	 *        	restrictions.
	 * @param array $optParams
	 *        	Optional parameters.
	 *        	
	 ...
	 * If a sub-object is specified, it will
	...
	public function updateUserSettings(Google_Service_Books_Usersettings $postBody, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'updateUserSettings', array (
				$params 
		), "Google_Service_Books_Usersettings" );
	}
}
...
class Google_Service_Books_MylibraryBookshelves_Resource extends Google_Service_Resource {
	 ...
	 *        	Position on shelf to move the item (0 puts the
...
class Google_Service_Books_MylibraryReadingpositions_Resource extends Google_Service_Resource {
	 ...
	 *
	 * @param string $volumeId
	 *        	ID of volume for which to retrieve a reading
	 *        	position.
	 * @param array $optParams
	 *        	Optional parameters.
	 *        	
	 ...
	 *
	 * @param string $volumeId
	 *        	ID of volume for which to update the reading
	 *        	position.
	 * @param string $timestamp
	 *        	RFC 3339 UTC format timestamp associated with this
	 *        	reading position.
...
class Google_Service_Books_Onboarding_Resource extends Google_Service_Resource {
	...
	public function listCategories($optParams = array()) {
		$params = array ();
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'listCategories', array (
				$params 
	...
	public function listCategoryVolumes($optParams = array()) {
		$params = array ();
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'listCategoryVolumes', array (
				$params 
