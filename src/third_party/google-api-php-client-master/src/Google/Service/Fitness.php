...
class Google_Service_Fitness extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->users_dataSources = new Google_Service_Fitness_UsersDataSources_Resource ( $this, $this->serviceName, 'dataSources', array (
				'methods' => array (
						'create' => array (
		...
		$this->users_dataSources_datasets = new Google_Service_Fitness_UsersDataSourcesDatasets_Resource ( $this, $this->serviceName, 'datasets', array (
				'methods' => array (
						'delete' => array (
		...
		$this->users_sessions = new Google_Service_Fitness_UsersSessions_Resource ( $this, $this->serviceName, 'sessions', array (
				'methods' => array (
						'delete' => array (
...
class Google_Service_Fitness_UsersDataSources_Resource extends Google_Service_Resource {
	 ...
	 * this user.
	 * The data stream ID field can be omitted and will be generated by
	 ...
	 *
	 * @param string $userId
	 *        	Create the data source for the person identified. Use
	 ...
	 *
	 * @param string $userId
	 *        	Retrieve a data source for the person identified. Use
	 *        	me to indicate the authenticated user. Only me is supported at this time.
	 ...
	 *        	me to indicate the authenticated user. Only me is supported at this time.
	 * @param string $dataSourceId
	 *        	The data stream ID of the data source to
	 *        	retrieve.
	 * @param array $optParams
	 *        	Optional parameters.
	 * @return Google_Service_Fitness_DataSource
	 ...
	 * scopes provided.
	 * The list is not exhaustive: the user may have private data
	 ...
	 * It is an error to modify the data source's data
	 ...
	 *
	 * @param string $userId
	 *        	Update the data source for the person identified. Use
	 *        	me to indicate the authenticated user. Only me is supported at this time.
	 * @param string $dataSourceId
...
class Google_Service_Fitness_UsersDataSourcesDatasets_Resource extends Google_Service_Resource {
	 ...
	 *
	 * @param string $userId
	 *        	Delete a dataset for the person identified. Use me to
	 *        	indicate the authenticated user. Only me is supported at this time.
	 * @param string $dataSourceId
	 *        	The data stream ID of the data source that
	 *        	created the dataset.
	 * @param string $datasetId
	 *        	Dataset identifier that is a composite of the
	 ...
	 * The dataset need not be previously created.
	 ...
	 *
	 * @param string $userId
	 *        	Patch a dataset for the person identified. Use me to
	 *        	indicate the authenticated user. Only me is supported at this time.
	 * @param string $dataSourceId
	 *        	The data stream ID of the data source that
	 *        	created the dataset.
...
class Google_Service_Fitness_UsersSessions_Resource extends Google_Service_Resource {
	 ...
	 *
	 * @param string $userId
	 *        	Delete a session for the person identified. Use me to
	 *        	indicate the authenticated user. Only me is supported at this time.
	 ...
	 *
	 * @param string $userId
	 *        	List sessions for the person identified. Use me to
	 *        	indicate the authenticated user. Only me is supported at this time.
	 * @param array $optParams
	 *        	Optional parameters.
	 *        	
	 ...
	 *
	 * @param string $userId
	 *        	Create sessions for the person identified. Use me to
	 *        	indicate the authenticated user. Only me is supported at this time.
	 * @param string $sessionId
