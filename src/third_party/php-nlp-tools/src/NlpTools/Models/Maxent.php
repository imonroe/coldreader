...
class Maxent extends LinearModel {
	 ...
	 * @param $opt An
	 *        	optimizer, we need a maxent optimizer
	 * @return void
	 */
	 ...
	 * document.
	 * This is done so that we can optimize without the need
	 ...
	 *
	 * @param $classes A
	 *        	set of the classes in the training set
	 * @param $tset A
	 *        	collection of training documents
	 * @param $ff The
	 *        	feature factory
	 ...
	 *        	document
	 * @param string $class
	 *        	A class for which we calculate the probability
