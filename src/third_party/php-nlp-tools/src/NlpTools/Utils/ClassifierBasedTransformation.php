...
class ClassifierBasedTransformation implements TransformationInterface {
	 ...
	 * that implements the ClassifierInterface.
	...
	public function transform($w) {
		$class = $this->cls->classify ( $this->classes, new RawDocument ( $w ) );
	 ...
	 * @param string $class        	
	 * @param
	 *        	array|TransformationInterface Either an array of transformations or a single transformation
	 */
