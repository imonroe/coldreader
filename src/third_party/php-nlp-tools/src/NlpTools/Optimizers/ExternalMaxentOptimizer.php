...
class ExternalMaxentOptimizer implements MaxentOptimizerInterface {
	 ...
	 *        	The path for an external optimizer executable
	 */
	 ...
	 *        	The features that fired for any document for any class @see NlpTools\Models\Maxent
	...
	public function optimize(array &$feature_array) {
		...
		$desrciptorspec = array (
				...
				2 => STDERR 
		) // Should that be redirected to /dev/null or like?
;
