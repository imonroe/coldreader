...
class MaxentGradientDescent extends GradientDescentOptimizer implements MaxentOptimizerInterface {
	...
	/**
	 * We initialize all weight for any feature we find to 0.
	 * We also
	 ...
	 *
	 * @param $feature_array All
	 *        	the data known about the training set
	 * @param $l The
	 *        	current set of weights to be initialized
	 * @return void
	 */
	 ...
	 * empirical expectation - predicted expectation .
	 * We need to
