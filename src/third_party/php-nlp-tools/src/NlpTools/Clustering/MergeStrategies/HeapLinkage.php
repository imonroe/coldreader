...
abstract class HeapLinkage implements MergeStrategyInterface {
	 ...
	 *        	The distance metric used to calculate the distance matrix
	 * @param array $docs
	 *        	The docs to be clustered
	 */
	 ...
	 * return them in the order y,x .
	 * This operation is to be done only
	 * once per merge so it doesn't add much overhead.
	 *
	 * Note: y will always be larger than x
	 *
	 * @param integer $index
	 *        	The index to be unraveled
	 ...
	 *
	 * @param integer $y
	 *        	The y coordinate (large)
	 * @param integer $x
	 *        	The x coordinate (small)
