...
class Euclidean implements CentroidFactoryInterface {
	 ...
	 *
	 * @param array $doc
	 *        	The doc data to transform to sparse vector
	 ...
	 *
	 * @param array $docs
	 *        	The docs from which the centroid will be computed
	 * @param array $choose
	 *        	The indexes from which the centroid will be computed (if empty all the docs will be used)
