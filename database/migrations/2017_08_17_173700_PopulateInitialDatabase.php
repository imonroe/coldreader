...
class PopulateInitialDatabase extends Migration
{
    ...
    public function up()
    {
		...
		DB::table('aspect_types')->insert([
			...
			['aspect_name' => 'API Result', 'aspect_description' => 'Results from a an API call to another system', 'is_viewable' => 1 ],
			['aspect_name' => 'Relationship', 'aspect_description' => 'A connection between two subjects', 'is_viewable' => 1 ],
			['aspect_name' => 'Lambda Function', 'aspect_description' => 'An aspect that performs some sort of calculation or function, rather than storing data', 'is_viewable' => 1 ],
		]);
