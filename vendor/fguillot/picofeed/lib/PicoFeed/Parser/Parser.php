...
abstract class Parser {
	 ...
	 *        	Feed content
	 * @param string $http_encoding
	 *        	HTTP encoding (headers)
	 * @param string $fallback_url
	 *        	Fallback url when the feed provide relative or broken url
	 */
...
;
	 ...
	 * Set config object.
	 *
	 * @param \PicoFeed\Config\Config $config
	 *        	Config instance
	 *        	
	 * @return \PicoFeed\Parser\Parser
	 */
	 ...
	 * Enable the content grabber.
	 *
	 * @param bool $needs_rule_file
	 *        	true if only pages with rule files should be
	 *        	scraped
	 *        	
	 * @return \PicoFeed\Parser\Parser
	 */
