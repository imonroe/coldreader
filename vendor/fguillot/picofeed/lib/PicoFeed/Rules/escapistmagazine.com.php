...
return array (
		'grabber' => array (
				'%/articles/view/comicsandcosplay/comics/critical-miss.*%' => array (
						'body' => array (
								'//*[@class="body"]/span/img | //div[@class="folder_nav_links"]/following::p' 
						),
				...
				'%/articles/view/comicsandcosplay/comics/namegame.*%' => array (
						'body' => array (
								'//*[@class="body"]/span/p/img[@height != "120"]' 
						),
				...
				'%/articles/view/comicsandcosplay/comics/paused.*%' => array (
						'body' => array (
								'//*[@class="body"]/span/p[2]/img | //*[@class="body"]/span/div/img' 
						),
