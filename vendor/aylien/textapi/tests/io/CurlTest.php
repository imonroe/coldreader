...
class CurlTest extends BaseTest {
	public function testIfAddsAcceptAndContentTypeHeaders() {
		...
		$this->assertContains ( 'Accept: application/json', $io->getRequestHeaders () );
		$this->assertContains ( 'Content-Type: application/x-www-form-urlencoded', $io->getRequestHeaders () );
	}
